---
name: gnome-header-bar
description: AdwHeaderBar layout rules: button placement, flat/icon-only buttons, tooltips, title widgets, split buttons. Use when designing or fixing a GNOME app's header bar.
---
